<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cat.aspx.cs" Inherits="FlowNET.cat" %>
        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header border-0">
              <h3 class="mb-0">عنوان الفئة</h3>
            </div>
            <div class="table-responsive">
              <table class="table align-items-center table-flush">
                <thead class="thead-light ">
                  <tr class="fs-4">
                    <th scope="col">المنتدى</th>
                    <th scope="col">المواضيع</th>
                    <th scope="col">الردود</th>
                    <th scope="col">آخر مشاركة</th>
                    <th scope="col">الطاقم الإداري</th>
